    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative">
      <div className="w-full max-w-[460px] bg-[rgba(15,23,36,0.6)] backdrop-blur-[20px] border border-[rgba(255,255,255,0.1)] rounded-[24px] p-12 px-10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] animate-[slideUp_0.5s_ease-out]">
        ...
        <div className="animate-[fadeIn_0.4s_ease]">
          <h2 className="text-2xl font-bold text-[var(--text)] m-0 mb-2 text-center">Welcome Back</h2>
          <p className="text-sm text-[var(--muted)] m-0 mb-8 text-center">Sign in to continue your learning journey</p>
          ...
          <form onSubmit={handleSignIn} className="flex flex-col gap-5">
            ...
            <button
              ...
              className="self-end bg-none border-none text-[var(--primary)] text-sm font-medium cursor-pointer p-0 -mt-2 transition-all duration-200 hover:text-[var(--accent)] hover:underline"
            >
              Forgot password?
            </button>
