...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative">
      <div className="w-full max-w-[460px] bg-[rgba(15,23,36,0.6)] backdrop-blur-[20px] border border-[rgba(255,255,255,0.1)] rounded-3xl p-12 px-10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] animate-[slideUp_0.5s_ease-out]">
        {/* Logo & Brand */}
        ...
        {/* Message Display */}
        {message && (
          <div className={`p-3.5 px-4 rounded-xl mb-6 text-sm font-medium animate-[fadeIn_0.3s_ease] ${
        ...
        <div className="animate-[fadeIn_0.4s_ease]">
          <h2 className="text-2xl font-bold text-[var(--text)] m-0 mb-2 text-center">Create Account</h2>
          <p className="text-sm text-[var(--muted)] m-0 mb-8 text-center">Join thousands of learners today</p>

          <form onSubmit={handleSignUp} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label htmlFor="name" className="text-sm font-semibold text-[var(--text)]">Full Name</label>
              <input
                id="name"
                type="text"
                value={name}
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                required
                minLength={8}
                className="w-full py-3.5 px-4 rounded-xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] text-(--text) text-[0.9375rem] transition-all duration-300 focus:outline-none focus:border-(--primary) focus:bg-[rgba(255,255,255,0.08)] focus:shadow-[0_0_0_3px_rgba(190,39,245,0.1)] placeholder:text-(--muted) placeholder:opacity-60"
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button onClick={() => handleSocialAuth('github')} className="flex items-center justify-center gap-2 py-[0.875rem] px-4 rounded-[12px] border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.03)] text-[var(--text)] text-[0.9375rem] font-medium cursor-pointer transition-all duration-300 hover:bg-[rgba(255,255,255,0.08)] hover:border-[rgba(255,255,255,0.2)] hover:-translate-y-0.5">
